...
<script>
	...
	function confirm1()
	{
			var r=confirm("If you want to delete this user press \"Ok\" otherwise press \"Cancel\" ");
			return r;
	}
				...
				<div id="content">
                    ...
                    <a href="http://localhost/project/admin.php">&laquo;Back</a>
                     ...
                     <td> <a href="update_pat_det.php?id=<?php echo $row['id']; ?>">update</a>&nbsp;
                     	<a href="delete_pat_det.php?id=<?php echo $row['id']; ?>" onClick="return confirm1()">delete</a>
                     </td>
                     </tr>
                      <?
					 }
